...
MODULE constants
  ...
  !
  REAL(DP), PARAMETER :: Avogadro_constant = 6.02214085700E+23_DP  ! mol^-1
  REAL(DP), PARAMETER :: H_PLANCK_SI       = 6.62606896000E-34_DP  ! J s
  REAL(DP), PARAMETER :: K_BOLTZMANN_SI    = 1.38065040000E-23_DP  ! J K^-1 
  REAL(DP), PARAMETER :: ELECTRON_SI       = 1.60217648700E-19_DP  ! C
  REAL(DP), PARAMETER :: ELECTRONVOLT_SI   = 1.60217648700E-19_DP  ! J  
  REAL(DP), PARAMETER :: ELECTRONMASS_SI   = 9.10938215000E-31_DP  ! Kg
  REAL(DP), PARAMETER :: HARTREE_SI        = 4.35974394000E-18_DP  ! J
  REAL(DP), PARAMETER :: RYDBERG_SI        = HARTREE_SI /  2.0_DP  ! J
  REAL(DP), PARAMETER :: BOHR_RADIUS_SI    = 0.52917720859E-10_DP  ! m
  REAL(DP), PARAMETER :: AMU_SI            = 1.66053878200E-27_DP  ! Kg
  REAL(DP), PARAMETER :: C_SI              = 2.99792458000E+08_DP  ! m sec^-1
  !
