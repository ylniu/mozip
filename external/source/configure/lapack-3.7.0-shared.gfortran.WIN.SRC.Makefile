...
../$(LAPACKLIB): $(ALLOBJ) $(ALLXOBJ) $(DEPRECATED)
	$(LOADER) $(LOADOPTS) -shared -Wl,-soname,liblapack.dll -o $@ $(ALLOBJ) $(ALLXOBJ) $(DEPRECATED) ../libblas.dll

#	$(LOADER) $(LOADOPTS) -shared -Wl,-soname,liblapack.so -o $@ $(ALLOBJ) $(ALLXOBJ) $(DEPRECATED)
